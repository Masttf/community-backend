...
public class FileController extends ABaseController {
    ...
    public void getAvatar(HttpServletResponse response,
        ...
        String avatarFolderPath = adminConfig.getProjectFolder() + Constans.FILE_FOLDER_FILE + FileUploadEnum.AVATAR.getFolder();
    ...
    private void readImage(HttpServletResponse response, String imageFolder, String imageName) {
        ...
        try {
            ...
            String filePath = adminConfig.getProjectFolder() + Constans.FILE_FOLDER_FILE + imageFolder + imageName;
